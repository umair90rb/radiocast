...
class SecSignUpScreen extends StatefulWidget {
  @override
  _SecSignUpScreenState createState() => _SecSignUpScreenState();
}

class _SecSignUpScreenState extends State<SecSignUpScreen> {
